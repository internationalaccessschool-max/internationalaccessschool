...
import { Loader2, Banknote, ArrowLeft, Eye, EyeOff } from "lucide-react";
import Link from "next/link";

const accountantLoginSchema = z.object({
    email: z.string().email("Invalid email address"),
    password: z.string().min(1, "Password is required"),
});

type AccountantLoginFormValues = z.infer<typeof accountantLoginSchema>;
...
export default function AccountantLoginPage() {
    ...
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<AccountantLoginFormValues>({
        resolver: zodResolver(accountantLoginSchema),
    });

    const onSubmit = async (data: AccountantLoginFormValues) => {
        setIsLoading(true);
        setError(null);
        ...
        try {
            ...
            // Verify role is actually accountant
            ...
            if (userDoc.exists()) {
                ...
                if (userData.role === "accountant") {
                    ...
                    setError("Access denied. Not an authorized accountant account.");
                    await auth.signOut();
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
                <div className="gradient-navy p-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h1 className="text-2xl font-bold text-white">Accountant Login</h1>
                        <p className="text-white/60 text-sm mt-1">Finance & Accounts</p>
                    </div>
                </div>
